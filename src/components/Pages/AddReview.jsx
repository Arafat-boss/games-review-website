...
const AddReview = () => {
  ...
  return (
    <div className="mt-10 ">
      ...
      {/* Add Header Text */}
      <h1 className="text-center text-3xl font-bold text-[#25000d] mb-6">
        Add Your Review
      </h1>
      <form
        onSubmit={handelAddReview}
        className="rounded-lg border-none max-w-xl mx-auto border-2 p-24 bg-[#ffe2ed] text-white shadow-xl"
      >
        <div className="relative z-0 w-full mb-5 group">
          <input
            ...
            id="floating_email"
            value={user?.email}
            className="block py-2.5 px-0 w-full text-sm text-[#25000d] bg-transparent border-0 border-b-2 border-black appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
            placeholder=""
            required
          />
          <label
